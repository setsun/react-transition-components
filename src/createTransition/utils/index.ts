 ...
 */
export const withTriggerReflow = (callback: Function, props: TransitionComponentProps) => (node: HTMLElement, ...rest) => {
  node && node.scrollTop;
...
export const getTransitionString = (
  ...
  return `all ${durationValue}ms ${easingValue} ${delayValue}ms`;
};
